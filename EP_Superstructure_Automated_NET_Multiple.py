...
def EP_Results(plant_data, period_data, period):
    ...
    print(' ')
    print('Minimum first choice of EP_NET Deployment in', period, '=', round(model.EP_NET_1(), 2), 'TWh/y')
    print(' ')
    print('Minimum second choice of EP_NET Deployment in', period, '=', round(model.EP_NET_2(), 2), 'TWh/y')
    print(' ') 
    print('Minimum third choice of EP_NET Deployment in', period, '=', round(model.EP_NET_3(), 2), 'TWh/y')
    print(' ') 
    print('Minimum first choice of EC_NET Deployment in', period, '=', round(model.EC_NET_1(), 2), 'TWh/y')
    print(' ')
    print('Minimum second choice of EC_NET Deployment in', period, '=', round(model.EC_NET_2(), 2), 'TWh/y')
    print(' ')
    print('Minimum third choice of EC_NET Deployment in', period, '=', round(model.EC_NET_3(), 2), 'TWh/y')
    print(' ')
    print('Minimum compensatory energy deployment in', period, '=', round(model.comp(),2), 'TWh/y')
    print(' ')
